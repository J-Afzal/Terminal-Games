...
namespace TerminalGames
{
    ...
    private:
        ...
        /**
         * @brief Loads in the words.txt file containing a list of the ~1,000 most used words in English (3-14 characters) which
         * will be used by the computer when selecting a word.
         */
        void LoadWords();
